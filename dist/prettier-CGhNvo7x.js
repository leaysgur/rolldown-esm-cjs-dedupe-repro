import { n as __esmMin, r as __exportAll } from "./chunk-BdzVc5A2.js";
...
//#region node_modules/prettier/doc.mjs
...
//#endregion
//#region node_modules/prettier/index.mjs
...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-Bnx2O-xX.js"));
	try {
...
${codeblock}`, options8);
	...
	estreePlugin = createParsersAndPrinters([{
		importPlugin: () => import("./estree-BeGMzyHW.js"),
	...
	({parsers, printers} = createParsersAndPrinters([
		{
			importPlugin: () => import("./acorn-E-8D1CPG.js"),
			parsers: ["acorn", "espree"]
		},
		{
			importPlugin: () => import("./angular-BQZmj94g.js"),
			parsers: [
				"__ng_action",
				"__ng_binding",
				"__ng_interpolation",
		...
		{
			importPlugin: () => import("./babel-Dseygxzc.js"),
			parsers: [
				"babel",
				"babel-flow",
				"babel-ts",
		...
		{
			importPlugin: () => import("./flow-B3KZlr6y.js"),
			parsers: ["flow"]
		},
		{
			importPlugin: () => import("./glimmer-BkH2wR-U.js"),
			parsers: ["glimmer"],
			printers: ["glimmer"]
		},
		{
			importPlugin: () => import("./graphql-CH558TW7.js"),
			parsers: ["graphql"],
			printers: ["graphql"]
		},
		{
			importPlugin: () => import("./html-ZtMw85rR.js"),
			parsers: [
				"html",
				"angular",
				"vue",
		...
		{
			importPlugin: () => import("./markdown-BAe5DSwg.js"),
			parsers: [
				"markdown",
				"mdx",
				"remark"
		...
		{
			importPlugin: () => import("./meriyah-ohmhMEs5.js"),
			parsers: ["meriyah"]
		},
		{
			importPlugin: () => import("./postcss-D_nwp8Rv.js"),
			parsers: [
				"css",
				"less",
				"scss"
		...
		{
			importPlugin: () => import("./typescript-BJHL4H-b.js"),
			parsers: ["typescript"]
		},
		{
			importPlugin: () => import("./yaml-Bnx2O-xX.js"),
			parsers: ["yaml"],
			printers: ["yaml"]
		}
	]));
...
//#endregion
export { formatWithCursor2 as a, index_exports as c, resolveConfig as d, resolveConfigFile as f, doc_exports as h, format2 as i, init_prettier as l, version_evaluate_default as m, clearCache3 as n, getSupportInfo2 as o, sharedWithCli as p, debugApis as r, get_file_info_default as s, check as t, public_exports as u };