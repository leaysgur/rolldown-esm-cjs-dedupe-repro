...
var Ci, _i, Ti, an, ln, nt, U, ke, st, v, cn, Ei, sn, fn, dn, mn, N, gn, vn, xn, wn, Sn, En, yn, Cn, c, S, rt, ot, at, lt, ct, Ne, ut, pt, x, ht, ft, dt, mt, gt, vt, Pe, xt, wt, o, l, St, Tn, X, g, Se, b, ne, Et, yt, Ct, de, _t, Le, Tt, me, kt, I, bt, At, It, Ii, E, ge, Me, Re, $e, Nt, Pt, Lt, De, Be, Oe, Ee, Mt, $, O, se, ye, Rt, kn, bn, L, An, pe, os, Ie, Ni, Pi, Li, as, Mi, ls, Ri, Wt, $i, In, cs, ve, q, Nn, us, Q, ps, H, Fe, j, fe, Di, k, Bi, Pn, Oi, Fi, qt, Vi, jt, te, it, G, Ui, Xe, hs, Hi, Wi, qi, ji, zi, Gi, Xi, fs, Ve, Ln, K, ds, $t, Ue, He, We, qe, Ce, Rn, $n, Dn, Yi, ms, Qi, Bt, zt, er, tr, gs, nr, sr, ir, f, ie, Bn, On, Fn, M, Vn, Un, Hn, Wn, R, qn, jn, je, Ot, Yn, Qn, or, Kn, xs, h, F, lr, _e, A, xe, Ae, Ft, Vt, Ut, oe, Z, ts, z, Ht, Er, ns, ss, is, ws, rs, Cr, _r, Tr, Je, Cs, _s, Ts, ks, bs, Ye, As, Is, Ns, Ps, br, Ls, Ar, Ir, Ms, Rs, $s, Ds, Bs, Os, Fs, Vs, Nr, Pr, Lr, Mr, Qe, Us, Hs, Ws, qs, js, zs, Gs, Xs, Js, Ys, Qs, Ks, Zs, Xt, ei, ti, ni, si, Rr, ii, oi, Ke, ai, li, ci, ui, pi, ae, J, m, di, C, Yt, Qt, Kt, mi, gi, vi, xi, le, Br, Ze, et, Zt, en, tn, Fr, Vr, Ur, Hr;
var init_angular = __esmMin((() => {
	...
	nt = (t, e, n) => e.has(t) || an("Cannot " + n);
	U = (t, e, n) => (nt(t, e, "read from private field"), n ? n.call(t) : e.get(t)), ke = (t, e, n) => e.has(t) ? an("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, n), st = (t, e, n, s) => (nt(t, e, "write to private field"), s ? s.call(t, n) : e.set(t, n), n), v = (t, e, n) => (nt(t, e, "access private method"), n);
	cn = (t, e, n) => Ti(_i(t), n, e);
	Ei = {};
	ln(Ei, { parsers: () => sn });
	sn = {};
	ln(sn, {
	...
	pe = 0;
	os = 9, Ie = 10, Ni = 11, Pi = 12, Li = 13, as = 32, Mi = 33, ls = 34, Ri = 35, Wt = 36, $i = 37, In = 38, cs = 39, ve = 40, q = 41, Nn = 42, us = 43, Q = 44, ps = 45, H = 46, Fe = 47, j = 58, fe = 59, Di = 60, k = 61, Bi = 62, Pn = 63, Oi = 48;
	Fi = 57, qt = 65, Vi = 69;
	jt = 90, te = 91, it = 92, G = 93, Ui = 94, Xe = 95, hs = 97;
	Hi = 101, Wi = 102, qi = 110, ji = 114, zi = 116, Gi = 117, Xi = 118;
	fs = 122, Ve = 123, Ln = 124, K = 125, ds = 160;
	$t = 96;
	Ue = class t {
		file;
		offset;
...
` && ++u == n)););
	...
	Yi = "(:(where|is)\\()?", ms = "-shadowcsshost", Qi = "-shadowcsscontext", Bt = "[^)(]*", zt = `(?:\\((${`(?:\\(${`(?:\\(${Bt}\\)|${Bt})+?`}\\)|${Bt})+?`})\\))`;
	...
	nr = "%COMMA_IN_PLACEHOLDER%", sr = "%SEMI_IN_PLACEHOLDER%", ir = "%COLON_IN_PLACEHOLDER%";
	new RegExp(nr, "g");
	new RegExp(sr, "g");
	new RegExp(ir, "g");
	;
...
\r	\v\u1680\u180E\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF`;
	...
	Ae = new A(-1, -1, h.Character, 0, ""), Ft = class {
		input;
		tokens = [];
		length;
		peek = 0;
	...
	Cr = "test.html";
	;
	Tr = (t) => oe.prototype._commentStart(t);
	Je = (t) => (e) => {
		let n = Ss(e);
		return ys({
			...n,
	...
	As = Object.defineProperty, Is = (t, e) => {
		let n = {};
	...
	Ar = { optional: !1 }, Ir = { optional: !0 }, Ms = ({ optional: t }) => (e, n) => {
	...
	Gs = (t, e) => e.transformChild(t.expression);
	Xs = (t, e) => ({
	...
	li = (t, e) => Ke.transform(t, e), ci = (t) => new ai(t).transform();
	ui = (t, e) => (n, s, ...i) => n | 1 && s == null ? void 0 : (e.call(s) ?? s[t]).apply(s, i);
	pi = ui("at", function() {
		if (Array.isArray(this) || typeof this == "string") return $r;
	});
	Br = (le = class extends Ye {
		constructor(n, s) {
			super(s);
			ke(this, m);
			ke(this, ae);
	...
	Ze(Ts);
	en = Ze(ks), tn = (t) => wi(bs(t).result.templateBindings, t);
	Fr = tt(et), Vr = tt(Zt), Ur = tt(en), Hr = tt(tn);
}));
