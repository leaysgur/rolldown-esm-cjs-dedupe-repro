import { n as __esmMin } from "./chunk-BdzVc5A2.js";
...
var Jr, Zr, ks, en, ir, xs, $e, tn, ws, xe, As, w, F, Ps, ze, Ye, je, St, Ae, ye, Et, Ne, Le, Pe, Oe, Ct, vt, Y, Tt, De, bt, wt, Ds, sr, rn, D, kt, sn, an, j, _, k, v, nn, cn, un, Fs, qs, pn, lr, y, cr, mn, Ws, Gs, dn, gn, zs, _n, Xs, En, Cn, Ie, ea, At, yt, ce, Xe, pr, bn, hr, wn, mr, ue, aa, fr, kn, Ea, Vn, Un, Er, va, Gn, $n, zn, wa, Yn, jn, Xn, Kn, xa, Aa, ya, Na, Zn, La, ei, ti, ri, Oa, ii, si, vr, G, Ra, Fa, pi, Q, te, hi, qt, Ya, fi, nt, Xa, di, I, _i, Si, Ei, Ci, vi, Ti, bi, wi, Ja, R, kr, xr, re, to, Vt, Di, ro, no, io, so, ao, Ii, oo, Ri, f, Mi, lt, qe, mt, h, Fi, ne, Ce, Hi, Vi, Ui, Wi, Gi, ie, $i, zi, ve, J, Yi, Nr, Lr, Pr, Te, l, Lo, Po, Mr, Do, ft, Io, is, Uo, Vr, N, Wo, ls, Go, us, Ur, $o, zo, ps, hs, ms, Wr, fs, ds, Qr, gs, cl, Zt, _s, er, Ss, oe, $r, zr, We, tr, pl, Yr, rr, wl, kl, xl, Al, yl, Nl, Ll;
var init_html = __esmMin((() => {
	Jr = Object.defineProperty;
	Zr = (e) => {
		throw TypeError(e);
	};
	ks = (e, t, r) => t in e ? Jr(e, t, {
		enumerable: !0,
		configurable: !0,
		writable: !0,
		value: r
	...
	ir = (e, t, r) => ks(e, typeof t != "symbol" ? t + "" : t, r), xs = (e, t, r) => t.has(e) || Zr("Cannot " + r);
	$e = (e, t, r) => (xs(e, t, "read from private field"), r ? r.call(e) : t.get(e)), tn = (e, t, r) => t.has(e) ? Zr("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r);
	ws = {};
	en(ws, {
		languages: () => ms,
		options: () => ds,
	...
	xe = (e, t) => (r, n, ...i) => r | 1 && n == null ? void 0 : (t.call(n) ?? n[e]).apply(n, i);
	As = String.prototype.replaceAll ?? function(e, t) {
	...
	Ps = () => {}, ze = Ps;
	Ye = "string", je = "array", St = "cursor", Ae = "indent", ye = "align", Et = "trim", Ne = "group", Le = "fill", Pe = "if-break", Oe = "indent-if-break", Ct = "line-suffix", vt = "line-suffix-boundary", Y = "line", Tt = "label", De = "break-parent", bt = new Set([
		St,
		Ae,
		ye,
		Et,
	...
	wt = Os;
	Ds = (e) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(e);
...
`,
	...
	dn = fn;
	gn = $s;
	zs = Array.prototype.toReversed ?? function() {
		return [...this].reverse();
	...
	ea = void 0;
	At = ta;
	yt = Symbol.for("PRETTIER_IS_FRONT_MATTER");
	ce = ra;
	Xe = 3;
	pr = ia;
	bn = "inline", hr = {
	...
	Er = (e) => (t, r, n) => x(b(n.node), t, { parser: e }, W), va = [
		{
			test(e) {
	...
	Gn = va;
	$n = ({ node: e }, t) => !t.parentParser && e.fullName === "class" && !e.value.includes("{{"), zn = (e, t, r) => b(r.node).trim().split(/\s+/u).join(" ");
	wa = new Set([
		"onabort",
		"onafterprint",
		"onauxclick",
	...
	Xn = ka;
	Kn = ({ node: e }, t) => e.fullName === "allow" && !t.parentParser && e.parent.fullName === "iframe" && !e.value.includes("{{");
	xa = /^[ \t\n\r\u000c]+/, Aa = /^[, \t\n\r\u000c]+/, ya = /^[^ \t\n\r\u000c]+/, Na = /[,]+$/, Zn = /^\d+$/, La = /^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/;
	ei = Pa;
	ti = (e) => e.node.fullName === "srcset" && (e.parent.fullName === "img" || e.parent.fullName === "source"), ri = {
		width: "w",
		height: "h",
		density: "x"
	}, Oa = Object.keys(ri);
	ii = ({ node: e }, t) => e.fullName === "style" && !t.parentParser && !e.value.includes("{{"), si = async (e, t, r) => K(await e(b(r.node), {
		parser: "css",
	...
	pi = qa;
	Q = (e) => e.sourceSpan.start.offset, te = (e) => e.sourceSpan.end.offset;
	hi = "<!doctype";
	qt = za;
	Ya = new Set([
		"if",
	...
	Si = "format";
	Ei = /^\s*<!--\s*@(?:noformat|noprettier)\s*-->/u, Ci = /^\s*<!--\s*@(?:format|prettier)\s*-->/u;
	vi = (e) => Ci.test(e), Ti = (e) => Ei.test(e), bi = (e) => `<!-- @${Si} -->
...
${e}`;
	...
	Ja = (e) => e?.kind === "angularControlFlowBlock" && (e.name === "case" || e.name === "default");
	R = (function(e) {
		return e[e.RAW_TEXT = 0] = "RAW_TEXT", e[e.ESCAPABLE_RAW_TEXT = 1] = "ESCAPABLE_RAW_TEXT", e[e.PARSABLE_DATA = 2] = "PARSABLE_DATA", e;
	})({});
	kr = { name: "custom-elements" }, xr = { name: "no-errors-schema" }, re = (function(e) {
	...
	;
	Di = class {};
	ro = "boolean", no = "number", io = "string", so = "object", ao = [
...
`) {
	...
	wl = gt(rr), kl = new Set(["mj-style", "mj-raw"]), xl = gt({
		...rr,
		name: "mjml",
